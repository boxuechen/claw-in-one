...
class RoomChatTranscriptCacheTest {
  ...
  @Test
  fun transcriptRoundTripKeepsFileAndUnsupportedMetadata() =
    runTest {
      val unsupported =
        ChatMessageContent(
          type = "unsupported",
      ...
      saveTranscript(
        messages =
          listOf(
            ChatMessage(id = "unsupported", role = "assistant", content = listOf(unsupported), timestampMs = 10),
            ChatMessage(
              id = "user-document",
              role = "user",
            ...
            ChatMessage(id = "assistant-document", role = "assistant", content = listOf(assistantDocument), timestampMs = 12),
            ChatMessage(id = "user-mixed", role = "user", content = listOf(mixedText, userDocument), timestampMs = 13),
            ChatMessage(id = "assistant-mixed", role = "assistant", content = listOf(mixedText, assistantDocument), timestampMs = 14),
          ),
      )
      ...
      assertEquals(listOf("assistant", "user", "assistant", "user", "assistant"), loaded.map { it.role })
      assertEquals("Alex (Slack)", loaded[1].senderLabel)
      assertEquals("run-document:user", loaded[1].idempotencyKey)
