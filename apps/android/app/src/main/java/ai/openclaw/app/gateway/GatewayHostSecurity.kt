...
/** Local Gateways must not be routed through an HTTP proxy inherited from Wi-Fi. */
internal fun shouldBypassGatewayProxy(rawHost: String?): Boolean = isLocalCleartextGatewayHost(rawHost)
